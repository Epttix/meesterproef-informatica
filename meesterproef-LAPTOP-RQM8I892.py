...
def draw_scr():
    global muren, speler_rect, spike, teleporteer_binnen, teleporteer_buiten, vijanden, eindzone_rect
    muren = []
    spike = []
    teleporteer_binnen = []
    teleporteer_buiten = []
...
# functie voor de beweging van de vijand
def vijand_beweging():
...
# kijkt of object botst met teleporters
...
# checkt of object met muur botst
...
# checkt of object met vijand botst, komt veel overeen met botsing_spikes
...
# checkt of object met de spike botst komt veel overeen met botsing_vijand
